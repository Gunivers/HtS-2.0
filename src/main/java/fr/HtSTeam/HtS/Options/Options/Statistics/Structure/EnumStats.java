...
public enum EnumStats {
	...
	KILLS_PLAYER_NAME (true, new HashSet<String>(), "`KILLS_PLAYER_NAME` TEXT NOT NULL", "Noms des des joueurs tués"),
	...
	TARGETS (true, new HashSet<String>(), "`TARGETS` TEXT NOT NULL", "Vos cibles");
