...
public class TimerTask {
	...
	private HashMap<IconBuilder<?>, ArrayList<Method>> methods = new HashMap<IconBuilder<?>, ArrayList<Method>>();
	
	/**
	 * Fetches all annoted methods and orders them by priority.
	 */
	private void initMethods() {
		for (IconBuilder<?> ib : IconBuilder.optionsList.keySet()) {
	...
	private void executeMethods() {
		for (Entry<IconBuilder<?>, ArrayList<Method>> set : methods.entrySet())
